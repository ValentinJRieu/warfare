...
public class LoadMenu extends JPanel {
    ...
    public LoadMenu(JFrame frame) {
        ...
        JButton autoSave = new JButton("Savegarde Automatique - VIDE");
        autoSave.setFont(font);
        autoSave.setBackground(new Color(50,50,50));
        ...
        autoSave.addMouseListener(new MouseAdapter() {
            @Override
